...
(function (global, $) {
    ...
    var find_api_base_url = function () {
        var url = false, regex = /(.*\/)vgmh-social(-min)?\.js(\?.*)?$/;
    ...
    global.VGMH.social = function (selector) {
    ...
    global.VGMH.social.btn_formatter = (function () {
        var default_cbtn;
        return function (fn) {
            if (!default_cbtn) {
    ...
    $('<link />', {
        rel: "stylesheet",
        type: "text/css",
        href: find_api_base_url() + "vgmh-social-min.css",
        media: 'none',
        onload: "if(media!='all')media='all'"
    }).appendTo("head");


    // bootstrap on .vgmh-social by default
    $(function () {
        global.VGMH.social('.vgmh-social');
    });
